...
const TECH_STACK = ["Laravel", "IOT"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/calldeo" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/deo-andreas-syaputra-401199277/" },
  { icon: Instagram, link: "https://www.instagram.com/_calldeo/" }
];
